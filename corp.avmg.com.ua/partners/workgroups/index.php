...
?><?$APPLICATION->IncludeComponent("bitrix:socialnetwork_group", "", array(
	...
	"NAME_TEMPLATE" => "",
	"PATH_TO_USER" => "/partners/contacts/personal/user/#user_id#/",
	"PATH_TO_USER_LOG" => "/partners/contacts/personal/log/",
	"PATH_TO_SUBSCRIBE" => "/partners/contacts/personal/subscribe/",
	"PATH_TO_GROUP_CREATE" =>"/partners/contacts/personal/user/#user_id#/groups/create/",
	"PATH_TO_SEARCH_EXTERNAL" => "/partners/contacts/index.php",
	"PATH_TO_MESSAGES_CHAT" => "/partners/contacts/personal/messages/chat/#user_id#/",
	"PATH_TO_USER_CALENDAR" => "/partners/contacts/personal/user/#user_id#/calendar/",
	"PATH_TO_MESSAGE_FORM_MESS" => "/partners/contacts/personal/messages/form/#user_id#/#message_id#/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_VIDEO_CALL" => "/partners/contacts/personal/video/#USER_ID#/",
	"PATH_TO_BIZPROC_TASK" => "/partners/contacts/personal/user/#user_id#/bizproc/#id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/partners/contacts/personal/user/#user_id#/bizproc/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/partners/workgroups/",
	"AJAX_MODE" => "N",
