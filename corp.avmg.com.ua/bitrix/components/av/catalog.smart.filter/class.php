...
class CBitrixCatalogSmartFilter extends CBitrixComponent
	...
	public function getIBlockItems($IBLOCK_ID, $SECTION_ID)
		{
		$items = array();
	...
	public function getResultItems()
		{
		$items = $this->getIBlockItems($this->IBLOCK_ID, $this->SECTION_ID);
		...
		if($this->SKU_IBLOCK_ID)
			...
			$skuSectionId = CIBlockSection::GetList
				(
				[],
					[
			...
			foreach($this->getIBlockItems($this->SKU_IBLOCK_ID, $skuSectionId) as $PID => $arItem)
				{
				$items[$PID] = $arItem;
