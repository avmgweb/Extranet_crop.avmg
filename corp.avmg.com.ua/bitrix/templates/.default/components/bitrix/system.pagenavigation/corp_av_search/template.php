...
?>
    <style>
        .blog-page-navigation a:hover {text-decoration: underline;}
        div.pagger-cell:hover {box-shadow: none !important;}
        div.blog-page-navigation a,div.blog-page-navigation span  {
            border: medium none;
            color: #CC0000;
        ...
        div.blog-page-navigation span {
        background-color: #CC0000;
            color: #FFF;
        }
        div.blog-page-navigation{    margin: 15px 0;
            text-align: center;}
    </style>
...
<?
	...
	if ($arResult["NavPageNomer"] > 1):
		if($arResult["bSavePage"]):
?>
			<a class="blog-page-previous" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><</a>
<?
		else:
...
?>
			<a class="blog-page-previous" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><</a>
<?
			endif;
...
?>
		<a class="blog-page-next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>">></a>
<?
	endif;
endif;
