...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	...
	<div class="bx-filter-section">
		<div class=" title-filter"><div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-12 <?else:?><?endif?> bx-filter-title"><span>ФИЛЬТР</span><div class="pull-right">  <button type="button" id="btn-filter" >
			...
			<div class="main-wrap">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?><?endif?> bx-filter-parameters-box bx-active arrayWrap">
							...
							<div class="bx-filter-block bx-active" data-role="bx_filter_block">
								<div class="col-md-12 bx-filter-parameters-box-container ">
