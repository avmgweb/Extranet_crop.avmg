...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			?>
			<script>
				BX.message({"AV_CATALOG_ELEMENT_INFO_TABLE_PRELOADER": '<?=GetMessage("AV_CATALOG_ELEMENT_INFO_TABLE_PRELOADER")?>'});
			</script>
			<div class="col-md-12">
				<div id="av-catalog-element-sku-table-wrap" data-params="<?=base64_encode(serialize($arResult["SKU_TABLE_INFO"]))?>">
