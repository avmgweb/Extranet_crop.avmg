...
if(count($iblockPropsArray))
	$arTemplateParameters["PICTURES_ALT"] =
		[
		"NAME"     => GetMessage("AV_CATALOG_ELEMENT_PARAMS_PICTURES_ALT"),
		"TYPE"     => "LIST",
...
$arTemplateParameters["ASK_FORM_ID"] =
	[
	"NAME" => GetMessage("AV_CATALOG_ELEMENT_PARAMS_ASK_FORM_ID"),
	"TYPE" => "STRING"
	];
$arTemplateParameters["ASK_FORM_LINK_FIELD_ID"] =
	[
	"NAME" => GetMessage("AV_CATALOG_ELEMENT_PARAMS_ASK_FORM_LINK_FIELD_ID"),
	"TYPE" => "STRING"
	];
$arTemplateParameters["ASK_FORM_COUNT_FIELD_ID"] =
	[
	"NAME" => GetMessage("AV_CATALOG_ELEMENT_PARAMS_ASK_FORM_COUNT_FIELD_ID"),
	"TYPE" => "STRING"
	];